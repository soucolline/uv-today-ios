...
class IndexTests: QuickSpec {
  ...
  override func spec() {
    describe("Index extension unit tests") {
      
      it("Should return the good color for the selected index") {
        for index in 0...15 {
          switch index {
      ...
      it("Should return the good description text for the selected index") {
        for index in 0...15 {
          switch index {
          case 0, 1, 2:
